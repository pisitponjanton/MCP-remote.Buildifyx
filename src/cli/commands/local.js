...
export async function runLocal(args = [], { metadata = null, updateStatus = null } = {}) {
  ...
  if (first === 'up') {
    ...
    console.log('  Security   Anyone with the exposed URL can use workspace permissions');
    return;
  }
